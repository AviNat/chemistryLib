...
ChemicalKeyboard.prototype.build=function(){
  var self=this,t=T[this.language]||T.en,root=node("div"),operatorsRow,statesRow,lowerRow,digitsPanel,digitsGrid,navigationRow,atomsPanel,atomsGrid,common,digits,i;
  ...
  root.appendChild(this.elementPanel);
  ...
  root.appendChild(this.atomPanel);
  ...
  ChemicalKeyboard.prototype.insertDigit =
    function (d) {
      var s = this.script;
  ...
  ChemicalKeyboard.prototype.insertText =
    function (s, script) {
      var i;
      var a = [];
...
ChemicalKeyboard.prototype.move=function(d){
    ...
    }else if(d>0&&this.cursor<this.chars.length&&(this.chars[this.cursor].kind==="state"||this.chars[this.cursor].kind==="element")){
...
ChemicalKeyboard.prototype.del=function(){
  var previous,pair,kind,start,end,removedScript,leftScript,rightScript;
   ...
   */
  if((removedScript==="sub"||removedScript==="sup")&&this.script===removedScript){
    ...
    if(leftScript!==removedScript&&rightScript!==removedScript){
      this.script="normal";
    }
  }
...
ChemicalKeyboard.prototype.render=function(){
  ...
  function appendCharacter(parent,index,mode){
    if(self.mode==="edit"&&self.cursor===index&&!cursorDrawn){
...
ChemicalKeyboard.prototype.openElements =
  function () {
    var self = this;
    var seen = {};
    var letters = [];
